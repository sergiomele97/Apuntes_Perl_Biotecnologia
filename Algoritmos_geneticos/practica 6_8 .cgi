...
$nodos = 7;
$long_cadena = 5;  ### LA MEJOR RESPUESTA ES CON 4 SALTOS: 16305, peso 4, aptitud 36

$NE = 10;   ### numero enorme o peso maximo de un invidividuo

@1000 = (0,2,2,$NE,$NE,1,$NE);   ### de un nodo a si mismo el peso es 0 para permitir repeticiones.
@1001 = ($NE,0,$NE,$NE,$NE,$NE,1); ### todos los individuos van a tener la misma longitud.
@1002 = ($NE,$NE,0,5,$NE,$NE,$NE);
@1003 = (1,1,5,0,3,8,$NE);
@1004 = ($NE,$NE,$NE,$NE,0,$NE,$NE);
@1005 = ($NE,$NE,$NE,$NE,$NE,0,7);
@1006 = ($NE,$NE,$NE,1,$NE,7,0);
...
sub mutacion {
        ...
        for ($i=0; $i<$tam_pob; $i++){
        	for ($j=1; $j<$r-1; $j++){    ########################### PARA QUE NO MUTEN NI EL PRIMERO NI EL ULTIMO
                	$aux = rand(1);
                        if($aux<=$pm) {
